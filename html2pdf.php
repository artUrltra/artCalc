        ...
        <div style='width: 100%;max-width: 100%;height: 99%;max-height: 99%;border: 1px solid #999999;'>
            ...
            if ($fotoInfo[1] != NULL) {
                ...
                <table align="center" style="width:100%;color:#666666;text-align:center;">
                    <tr>
                        ...
                        <td style=" width: 50%"> <?php if ($fotoInfo[1] != "" && @fopen($fotoInfo[1], "r")) {
            ...
            <div class="pdfooter">
                ...
                <p style="text-align:center;font-size:15px;" class="pdfitalic">
                    ...
                    подготовил менеджер : <?= $data["manager"] ?> <?= $data["manager_phone"] ?> <?= $data["mail"] ?>
                    <br/>
                </p>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td style="width:59%;">
                                        ...
                                        <p style="margin-bottom:0px;margin-top:0px;text-align:right;font-size:18px;">
                                            <?php if ($profilInfo[2][$j]['count'] > 0) echo round($profilInfo[2][$j]['price'] / $profilInfo[2][$j]['oneprice']) . " шт."; else echo round((nPrice($profilInfo[2][$j]['price'], $per, 2) / nPrice($profilInfo[2][$j]['oneprice'], $per, 1)), PHP_ROUND_HALF_UP) . " п/м."; ?>
                                            &nbsp;&nbsp;<span class="pdfbold"
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    ...
                                                    <td style="width:49%;vertical-align:bottom;">
                                                        <p style="text-align:center; color:white;background-color: white;">
                                                            <img
                                                                    src="<?= $furnituraInfo[0][$i]["img"] != "" && @fopen("admin/" . $furnituraInfo[0][$i]["img"], "r") ? "admin/" . $furnituraInfo[0][$i]["img"] : "img/notselected.png" ?>"
                                ...
                                <td style="width:69%;">
                                    ...
                                    <p style="text-align:right;">
                                        <span
                                            ...
                                            руб</span><br/>
                                        <span class="pdfitalic"
                                              style="color:royalblue;">Варианты замены смотрите на стр. <?= $altPage + 2 ?></span>
                                    </p>
                                </td>
                            </tr>
                        </table>
...
-->
                ...
                ?>
                <span class="pdfbold"
                      style="color:#666666;font-size:20px;"><?= number_format(round($priceFull2 / $setsNumber), 0, "", " ") ?></span>
...
-->
                ...
                ?>
                <span class="pdfbold"
                      style="color:#666666;font-size:20px;"><?= number_format($priceFull3 / $setsNumber, 0, "", " ") ?></span>
                <span style="color:#666666;font-size:20px;"> руб.</span>
                <!--
            <?php if ($setsNumber > 1) : ?>
            <br />
