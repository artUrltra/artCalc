...
let save = {
    ...
    getFm(){
        return $('#furnitura-tab .facture').val();
    },
    init()
    {
        if (this.flag) {
    ...
    get()
    {
        ...
        $('#furnitura-tab .facture').val(i.fm);
