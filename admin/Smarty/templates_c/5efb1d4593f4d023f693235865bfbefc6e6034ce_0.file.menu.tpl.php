<?php
/* Smarty version 3.1.30, created on 2017-05-30 16:54:33
  from "C:\xampp\htdocs\admin\Smarty\templates\menu.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_592d87a9e50a29_46947139',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5efb1d4593f4d023f693235865bfbefc6e6034ce' => 
    array (
      0 => 'C:\\xampp\\htdocs\\admin\\Smarty\\templates\\menu.tpl',
      1 => 1493376594,
      2 => 'file',
    ),
  ),
...
function content_592d87a9e50a29_46947139 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!-- Static navbar -->
...
?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['catalog']->value, 'i');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['i']->value) {
?>
                            <li><a href="../admin/index.php?page=Catalogs&id=<?php echo $_smarty_tpl->tpl_vars['i']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['i']->value['name'];?>
</a></li>
                        <?php
}
...
?>
                        ...
                        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['catalog1']->value, 'i');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['i']->value) {
?>
                            <li><a href="../admin/index.php?page=Catalogs&id=<?php echo $_smarty_tpl->tpl_vars['i']->value['id'];?>
...
?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="current"><a href="../admin/index.php?page=manufacturer">Производители для Фурнитуры</a></li>
                    </ul>
                </li>
            </ul>
