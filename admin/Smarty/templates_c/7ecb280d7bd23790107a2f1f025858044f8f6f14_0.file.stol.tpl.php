<?php
/* Smarty version 3.1.30, created on 2016-12-28 18:39:26
  from "C:\OpenServer\domains\ArtCalc.loc\admin\Smarty\templates\stol.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5863dcaea20ad6_27156320',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7ecb280d7bd23790107a2f1f025858044f8f6f14' => 
    array (
      0 => 'C:\\OpenServer\\domains\\ArtCalc.loc\\admin\\Smarty\\templates\\stol.tpl',
      1 => 1482939516,
      2 => 'file',
    ),
  ),
...
function content_5863dcaea20ad6_27156320 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <div id="form">
            ...
            <div class="row">
                <div class="col-md-6"><input type="number" class="form-control" id="price"
                                             placeholder="Цена"></div>
                <div class="col-md-6"><input type="number" class="form-control" id="priceK"
                                             placeholder="Цена крепежа"></div>
                </div>
...
?>
            ...
            <center>
                <textarea cols="47" rows="5"  class="form-control" id="characteristics" placeholder="Характеристики"></textarea>
...
/<?php echo $_smarty_tpl->tpl_vars['item']->value['priceK'];?>
</var></td>
            ...
            <div class="modal-body">
                <form id="modalform">
                    <div class="form-group"><input type="text" id="editid">
                        ...
                        <div class="row">
                            <div class="col-md-3">Высота до (м):<br /><input type="text" class="form-control" id="edit_height"
                                                         placeholder="Высота до"></div>
                            <div class="col-md-3">Паз (мм):<br /><input type="text" class="form-control" id="edit_paz"
                                                         placeholder="Паз"></div>

                            <div class="col-md-3">Стекло (мм):<br /><input type="text" class="form-control" id="edit_steklo"
                                                         placeholder="Стекло"></div>
                            <div class="col-md-3">Глухие панели (мм):<br /><input type="text" class="form-control" id="edit_penal"
                                                         placeholder="Глухие панели"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">Цена:<br /><input type="text" class="form-control" id="edit_price"
                                                         placeholder="Цена"></div>
                            <div class="col-md-6">Цена крепежа:<br /><input type="text" class="form-control" id="edit_priceK"
                                                         placeholder="Цена крепежа"></div>
                        </div>
...
>
    ...
    function submit() {
        ...
        switch(index){
            case 0:{
                ...
                var data = name + formula + max + image + item1 + item2 + item3 + item4 +price+priceK+view + priceDekor + priceColor + priceAnod + characteristics  + description + benefits + doubleFilling;
    ...
    function uploadimg() {
        var img = 'uploads/' + $('#img_name').html();
        $('#edit_img').attr('src',img);
    }
    $('#edit_img').click(function () {
        $('#form_img').click();
        setTimeout(uploadimg, 5000);
    });
    ...
    $('#edit_submit').click(function () {
        var data = 'name='+$("#edit_name").val()+'&max='+ $("#edit_max").val()+'&paz='+ $("#edit_paz").val()+'&height='+$("#edit_height").val()+'&steklo='+$("#edit_steklo").val()
                +'&penal='+$("#edit_penal").val()+'&priceDekor='+$("#edit_priceDekor").val()+'&priceColor='+$("#edit_priceColor").val()+'&priceAnod='+$("#edit_priceAnod").val()
                +'&priceAnod='+$("#edit_priceAnod").val()+'&characteristics='+$("#edit_characteristics").val()+'&description='+$("#edit_description").val()
                +'&benefits='+$("#edit_benefits").val()+'&doubleFilling='+$("#edit_doubleFilling").val()+'&img='+$('#edit_img').attr('src')+'&id='+$("#editid").val()+'&price='+$("#edit_price").val()+'&priceK='+$("#edit_priceK").val();
