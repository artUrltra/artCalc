<?php
/* Smarty version 3.1.30, created on 2017-01-10 16:59:42
  from "C:\OpenServer\domains\NewCalc\admin\Smarty\templates\furnitura1.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5874e8ce858110_36317864',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'add2b55d06de4650cd51743e9253a135e3d317ca' => 
    array (
      0 => 'C:\\OpenServer\\domains\\NewCalc\\admin\\Smarty\\templates\\furnitura1.tpl',
      1 => 1484054559,
      2 => 'file',
    ),
  ),
...
function content_5874e8ce858110_36317864 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Фурнитура :: Механизмы</title>
...
<div class="container">
    ...
    <div class="jumbotron">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-8"><h2>Фурнитура :: Механизмы</h2></div>
...
">
                        <td><?php if ($_smarty_tpl->tpl_vars['item']->value['cview'] == 1) {?>Раздвижная<?php } elseif ($_smarty_tpl->tpl_vars['item']->value['cview'] == 2) {?>Складная<?php }?></td>
...
?>
                        ...
                        Характеристики:<br/><textarea cols="86" rows="4" id="edit_characteristics"></textarea><br/>
                        Описание:<br/><textarea cols="86" rows="4" id="edit_description"></textarea><br/>
                        Преимущества:<br/><textarea cols="86" rows="4" id="edit_benefits"></textarea><br/>
                        <div>
                </form>
                <form action="parserFurnitura.php" class="dropzone"></form>
            </div>
